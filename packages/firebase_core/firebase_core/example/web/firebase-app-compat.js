!(function (e, t) {
  ...
  function he(e, t = {}) {
    ...
    if (((r = r || h()), !r)) throw oe.create('no-options');
    var i = te.get(a);
    if (i) {
    ...
    async read() {
      if (await this._canUseIndexedDBPromise) {
        var e = await (async function (e) {
          try {
            const r = await _e();
            return await r.transaction(me).objectStore(me).get(ye(e));
          } catch (e) {
            var t;
            e instanceof o
              ? q.warn(e.message)
  ...
  function Le(a) {
    ...
    function o(e) {
      if (((e = e || Q), !p(i, e))) throw Ae.create('no-app', { appName: e });
      return i[e];
    }
    return (
      (s.default = s),
  ...
  const Te = Ne;
  ue('@firebase/app-compat', '0.2.26', void 0);
  return Te.registerVersion('firebase', '10.7.2', 'app-compat-cdn'), Te;
});
